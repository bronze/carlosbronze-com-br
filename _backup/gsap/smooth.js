        ...
        var Smooth=(function () {
          function Smooth() {
            ...
            this.vs=this.vars.native
              ? null
              :new _virtualScroll2.default({
                limitInertia:
                  (this.options.vs&&this.options.vs.limitInertia)||
                  false,
                mouseMultiplier:
                  (this.options.vs&&this.options.vs.mouseMultiplier)||1,
                touchMultiplier:
                  (this.options.vs&&this.options.vs.touchMultiplier)||
                  1.5,
                firefoxMultiplier:
          ...
          _createClass(Smooth, [
            ...
            },
            {
              ...
              value: function calc(e) {
                var delta=
                  this.vars.direction=='horizontal'? e.deltaX:e.deltaY
                ...
                if (!this.vars.native&&!this.options.noscrollbar) {
                  ...
                  var bounds=
                    this.vars.direction==='vertical'
                      ...
                      :this.vars.width
                  var value=
                    Math.abs(this.vars.current)/
                    (this.vars.bounding/(bounds-size))+
                    size/0.5-
                    size
                  var clamp=Math.max(
                    0,
                    Math.min(value-size, value+size),
                  )
                  this.dom.scrollbar.drag.el.style[this.prefix]=
                    this.getTransform(clamp.toFixed(2))
                }
            ...
            },
            {
              ...
              value: function on() {
                ...
                var node=
                  this.dom.listener===document.body
                    ? window
                    :this.dom.listener
                this.vars.native
                  ? _domEvents2.default.on(node, 'scroll', this.debounce)
              ...
              value: function off() {
                ...
                var node=
                  this.dom.listener===document.body
                    ...
                    :this.dom.listener
                this.vars.native
                  ? _domEvents2.default.off(node, 'scroll', this.debounce)
            ...
            },
            {
              ...
              value: function addFakeScrollBar() {
                ...
                _domEvents2.default.on(
                  this.dom.scrollbar.el,
                  'click',
                  this.calcScroll,
                )
                _domEvents2.default.on(
            ...
            },
            {
              ...
              value: function calcScroll(e) {
                var client=
                  this.vars.direction=='vertical'? e.clientY:e.clientX
                var bounds=
                  this.vars.direction=='vertical'
                    ? this.vars.height
                    :this.vars.width
            ...
            },
            {
              ...
              value: function resize() {
                var prop=
                  this.vars.direction==='vertical'? 'height':'width'
                ...
                if (!this.extends) {
                  ...
                  this.vars.bounding=
                    this.vars.direction==='vertical'
                      ...
                      :bounding.right-
                      (this.vars.native? 0:this.vars.width)
                }
                if (!this.vars.native&&!this.options.noscrollbar) {
                  this.dom.scrollbar.drag.height=
                    this.vars.height*
                    (this.vars.height/
                      (this.vars.bounding+this.vars.height))
            ...
            },
            {
              ...
              value: function destroy() {
                ...
                this.vars.direction==='vertical'
                  ? _domClasses2.default.remove(this.dom.listener, 'y-scroll')
                  :_domClasses2.default.remove(this.dom.listener, 'x-scroll')
                this.vars.current=0
        ...
        function create(opt) {
          ...
          if (opt.attr)
            for (var index in opt.attr)
              opt.attr.hasOwnProperty(index)&&
                el.setAttribute(index, opt.attr[index])
